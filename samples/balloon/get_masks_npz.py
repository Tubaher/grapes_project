...
if __name__ == "__main__":
    ...
    for folder in folders:
        ...
        annotations = json.load(open(os.path.join(args.dataset_dir, folder + "/via_region_data.json")))
        ...
        for a in annotations:
            ...
            image_path = os.path.join(args.dataset_dir, folder + "/"+ a['filename'])
            ...
            compress_path = os.path.join(args.dataset_dir, folder + "/" + base_name + ".npz")
